...
export const MobileMenu: React.FC = () => {
    ...
    return (
        <>
            <div
                className={`absolute top-0 left-0 w-screen h-screen bg-slate-200 dark:bg-slate-800 p-2 transition${
            ...
            <button
                className="absolute z-30 left-2 top-4 cursor-pointer"
                onClick={handleMenu}
                aria-label="settings-menu"
            >
                {isActive ? (
                    <CgClose className="mx-2" />
                ) : (
